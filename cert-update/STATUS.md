...
_Last checked: 2026-05-30 23:19:26 +04_

| field | value |
|---|---|
| cert state | `authorization_created` |
| https_enforced | `False` |
| live HTTPS code | `000` |
| www -> (Cloudflare) | fernfant.github.io. |
| apex A (Cloudflare) | 185.199.110.153, 185.199.108.153, 185.199.111.153, 185.199.109.153 |
